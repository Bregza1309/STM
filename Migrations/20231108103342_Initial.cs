        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderId = table.Column<string>(name: "Sender_Id", type: "nvarchar(max)", nullable: false),
                    RecipientId = table.Column<string>(name: "Recipient_Id", type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentTrip", x => new { x.MyTripsTripId, x.StudentsStudentId });
                    table.ForeignKey(
                        name: "FK_StudentTrip_Students_StudentsStudentId",
                        column: x => x.StudentsStudentId,
                        principalTable: "Students",
                        principalColumn: "StudentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentTrip_Trips_MyTripsTripId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Verifications_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "DriverId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentTrip_StudentsStudentId",
                table: "StudentTrip",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Verifications_DriverId",
                table: "Verifications",
                column: "DriverId");
